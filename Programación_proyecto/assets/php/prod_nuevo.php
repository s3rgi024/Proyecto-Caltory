<?php
    ...
    $sentencia = $db->query("SELECT tipo_prod FROM categoria_producto");
  ...
  <section class="container">
          <div class="row position-relative">
                ...
                <div class="col-6 rounded shadow-sm mb-3 p-4 position-absolute top-0 start-50 translate-middle-x mt-5 bg-white">
                  <h2 class="fw-bold text-center">Insertar Nuevo Producto</h2>

                  
                  <form method="POST">
                    <div class="mb-2 mt-4">
                      <label for="nom_prod" class="form-label"><i class="fas fa-store"></i> Nombre del producto</label>
                      <input type="text" id="nom_prod" class="form-control" name="nom_prod" placeholder="Ingrese aquí el nombre del producto" required>
                    </div>

                    <div class="mb-2">
                      <label for="precio" class="form-label"><i class="fa-solid fa-badge-dollar"></i> Precio del Producto</label>
                      <input type="number" id="precio" class="form-control" name="precio" placeholder="Ingrese aquí el precio del producto" required>
                    </div>

                    <div class="mb-2">
                      <label for="cant_disp" class="form-label"><i class="fa-solid fa-input-numeric"></i> Cantidad de unidades disponibles</label>
                      <input type="number" id="cant_disp" class="form-control" name="cant_disp" placeholder="Ingrese aquí la cantidad de productos disponibles" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="categoria" id="categoria">
                            ...
                            foreach ($categorias as $key => $dato) {
                                ?>
                                    <option><?php echo $dato->tipo_prod; ?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <div class="d-grid">
                      <button type="submit" class="btn btn-secondary mb-2" onclick="this.form.action = '?action=insertar_prod';">Registrar Nuevo Producto <i class="fa-solid fa-arrow-right-from-bracket"></i></button>
                    </div>
