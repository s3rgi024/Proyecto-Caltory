$(document).ready(function(){
    ...
    $('.btn-exit').on('click', function(){
    	swal({
		 	...
		 	text: "Tendrá que volver a iniciar sesión en caso de querer ingresar al sistema",
		  	type: 'warning',
...
$('.eliminar_mercancia').on('click', function(){
	swal({
		  title: '¿Está seguro de eliminar este Insumo/Producto?',
		  type: 'warning',
		  showCancelButton: true,
		  confirmButtonText: 'Si, salir',
		  cancelButtonText: 'Cancelar',
