...
<meta charset="UTF-8">
    ...
    <link rel="shortcut icon" href="../img/Isotipo Caltory.png" type="image/x-icon">
...
<body>
        ...
        <section class="container">
            ...
            <div class="col-12 bg-white rounded-top">
                <h2 class="fw-bold text-center py-1 mt-4">¡Actualiza tus<br>Datos! <i class="fas fa-grin-wink"></i></h2>
            </div>
                ...
                <div class="col-12 bg-white mb-3 rounded-bottom ps-5 pe-5">
                    <div class="d-grid pb-2">
                        <button type="submit" name="registro" class="btn btn-primary" onclick="this.form.action = '?action=registrar';">Actualizar <i class="fas fa-arrow-circle-right"></i></button>
                    </div>
